...
class ReportsController
{
    public function report(int $spotId): void
    {
        ...
        $res = DatabaseAdapter::report($user['id'], $spotId, $reason);
    ...
    public function list(): void
    {
        ...
        $reports = DatabaseAdapter::listReports($status);
    ...
    public function moderate(int $reportId): void
    {
        ...
        $res = DatabaseAdapter::moderateReport($reportId, $status, $user['id'], $note);
        if (isset($res['error'])) ApiResponse::error($res['error'], 400);
